...
| Process step                         | Execution time*   |  Dependend on   | Downloaded size | Disc space needed |
| ------------------------------------ | ----------------- | --------------- | --------------- | ----------------- |
